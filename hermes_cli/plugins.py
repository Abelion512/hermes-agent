...
class PluginManager:
    ...
    def __init__(self) -> None:
        ...
        self._context_engine: Optional[Any] = (
            None  # Set by a plugin via register_context_engine()
        )
        self._plugin_commands: Dict[
            str, dict
        ] = {}  # Slash commands registered by plugins
        self._discovered: bool = False
        self._cli_ref: Optional[Any] = None  # Set by CLI after plugin discovery
...
def resolve_plugin_command_result(result: Any) -> Any:
    ...
    try:
        ...
        # Wrap in a coroutine to satisfy type checkers if result is a raw Awaitable
        async def _wrap():
            return await result
    ...
    def _runner() -> None:
        try:
            ...
            outcome["value"] = asyncio.run(_wrap())
