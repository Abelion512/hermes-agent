...
def format_duration_compact(*args, **kwargs):
    from hermes_cli.utils.formatting import format_duration_compact as _impl
    return _impl(*args, **kwargs)


def format_token_count_compact(*args, **kwargs):
    from hermes_cli.utils.formatting import format_token_count_compact as _impl
    return _impl(*args, **kwargs)
...
def _strip_reasoning_tags(text: str) -> str:
    from hermes_cli.utils.formatting import strip_reasoning_tags as _impl
    return _impl(text)
        ...
        if canonical in {"quit", "exit"}:
            ...
            if base_cmd.lstrip("/") in quick_commands:
                ...
                if qcmd.get("type") == "exec":
                    ...
                    if exec_cmd:
                        try:
                            # shell=False is used for security to prevent command injection, even though
