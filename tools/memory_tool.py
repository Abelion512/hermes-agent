...
class MemoryStore:
    ...
    def _sanitize_entries_for_snapshot(entries: List[str], filename: str) -> List[str]:
        ...
        for entry in entries:
            ...
            # Privacy first: redact secrets from the system prompt snapshot.
            entry = redact_sensitive_text(entry, force=True)
    ...
    def add(self, target: str, content: str) -> Dict[str, Any]:
        ...
        # Privacy first: redact secrets before they enter storage.
    ...
    def replace(self, target: str, old_text: str, new_content: str) -> Dict[str, Any]:
        ...
        # Privacy first: redact secrets before they enter storage.
        new_content = redact_sensitive_text(new_content, force=True)
